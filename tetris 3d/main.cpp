/*
    ...
    -For finding the maximum, in the end nodes, we call for values that apply to and element in the segment and in other nodes, the maximum value that appears in the whole segment.
*/
#include <bits/stdc++.h>
